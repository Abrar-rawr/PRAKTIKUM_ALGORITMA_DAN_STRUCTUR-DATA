...
int main()
{
    ...
    do
    {
        ...
        case 11:
            cout << "\nTERIMA KASIH" << endl;
            cout << "Program was made by Muhammad Abrar (2510817310001)." << endl;
            break;
        default:
...
void sisipkanSebelum()
{
    if (isEmpty() == 0)
    {
        ...
        if (apaAda == true)
        {
            ...
            cout << "Data \"" << dataBaru << "\" telah berhasil disisipkan sebelum data \"" << nextData << "\"." << endl;
        }
        else
        {
...
void sisipkanSetelah()
{
    if (isEmpty() == 0)
    {
        ...
        if (apaAda == true)
        {
            ...
            cout << "Data \"" << dataBaru << "\" telah berhasil disisipkan setelah data \"" << prevData << "\"." << endl;
        }
        else
        {
